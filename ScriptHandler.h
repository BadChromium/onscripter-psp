...
#define ONS_FULLWIDTH_MINUS_1 ((char)0xad)
#define ONS_FULLWIDTH_DIGIT_0 ((char)0xa3)
#define ONS_FULLWIDTH_DIGIT_1(n) ((char)(0xb0 + (n)))
#else
#define ONS_FULLWIDTH_SPACE_0 ((char)0x81)
#define ONS_FULLWIDTH_SPACE_1 ((char)0x40)
#define ONS_FULLWIDTH_MINUS_0 ((char)0x81)
#define ONS_FULLWIDTH_MINUS_1 ((char)0x7c)
#define ONS_FULLWIDTH_DIGIT_0 ((char)0x82)
#define ONS_FULLWIDTH_DIGIT_1(n) ((char)(0x4f + (n)))
#endif
...
public:
    ...
    enum { SCREEN_SIZE_640x480 = 0,
           ...
           SCREEN_SIZE_SCRIPT = 4
    };
    int script_width, script_height;
    int script_variable_range;
