...
int ScriptParser::open()
{
    ...
    switch ( script_h.screen_size ){
      ...
      case ScriptHandler::SCREEN_SIZE_320x240:
        ...
        break;
      case ScriptHandler::SCREEN_SIZE_SCRIPT:
        screen_ratio1 = 1;
        screen_ratio2 = 1;
        screen_width  = script_h.script_width;
        screen_height = script_h.script_height;
        break;
...
int ScriptParser::saveGlovalData()
{
    if ( !globalon_flag ) return 0;
    ...
    return saveFileIOBuf( "gloval.sav" );
}
